...
<div class='blog-page'>
		<div class="blog-center-container">
			...
			<div class="blog-content-container">
				...
				<p><p class='prelude'>This article is a bit long if you want to go straight to the code it <a href="https://github.com/Otomakan/hardcorejs.fun/tree/master/docs/javascript/13-04-2020-building-a-line-chart-with-d3">is available in this Github Repository</a></p>
